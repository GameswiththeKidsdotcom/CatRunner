...
**UI visuals**: When the idea involves new screens, layouts, or brand elements, invoke the **ui-designer** subagent to generate mockups or specs for the Quick MVP / Scalable / Innovative approaches. Example: "Use the ui-designer subagent to create a mockup or spec for [approach name] [screen/asset type]."
