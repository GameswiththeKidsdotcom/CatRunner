...
- **UI-test and logic-test plans**: e.g. [`.cursor/Plans/subplans/P001/ui-test.plan.md`](../Plans/subplans/P001/ui-test.plan.md), [`.cursor/Plans/subplans/P001/logic-test.plan.md`](../Plans/subplans/P001/logic-test.plan.md), [C10-validation-chunks](../Plans/subplans/P001/C10-validation-chunks.plan.md). Align with existing journey definitions; extend or refine instead of duplicating.
